...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hacom.orders.grpc.OrderRequest,
      com.hacom.orders.grpc.OrderResponse> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateOrder",
      requestType = com.hacom.orders.grpc.OrderRequest.class,
      responseType = com.hacom.orders.grpc.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hacom.orders.grpc.OrderRequest,
      com.hacom.orders.grpc.OrderResponse> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<com.hacom.orders.grpc.OrderRequest, com.hacom.orders.grpc.OrderResponse> getCreateOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getCreateOrderMethod = OrderServiceGrpc.getCreateOrderMethod) == null) {
          OrderServiceGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<com.hacom.orders.grpc.OrderRequest, com.hacom.orders.grpc.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hacom.orders.grpc.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hacom.orders.grpc.OrderResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createOrder(com.hacom.orders.grpc.OrderRequest request,
        io.grpc.stub.StreamObserver<com.hacom.orders.grpc.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void createOrder(com.hacom.orders.grpc.OrderRequest request,
        io.grpc.stub.StreamObserver<com.hacom.orders.grpc.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public com.hacom.orders.grpc.OrderResponse createOrder(com.hacom.orders.grpc.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hacom.orders.grpc.OrderResponse> createOrder(
        com.hacom.orders.grpc.OrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((com.hacom.orders.grpc.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.hacom.orders.grpc.OrderResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.hacom.orders.grpc.OrderRequest,
              com.hacom.orders.grpc.OrderResponse>(
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hacom.orders.grpc.OrderProto.getDescriptor();
    }
