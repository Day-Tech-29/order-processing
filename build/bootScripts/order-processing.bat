...
set JARPATH=%APP_HOME%\lib\order-processing-1.0.0.jar

@rem Execute order-processing
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ORDER_PROCESSING_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ORDER_PROCESSING_EXIT_CONSOLE%" exit 1
exit /b 1
